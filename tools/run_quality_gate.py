...
from src.ocr_quality_gate import AUTO_PASS_THRESHOLD, run_quality_gate, run_quality_gate_for_text
...
def parse_args() -> argparse.Namespace:
    ...
    input_group.add_argument("--result-json", help="Path to OCR experiment result.json.")
    input_group.add_argument("--text", help="Path to raw OCR text file.")
...
def main() -> int:
    args = parse_args()
    if args.text:
        result = run_quality_gate_for_text(
            text_path=args.text,
